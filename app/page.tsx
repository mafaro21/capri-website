...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          {slides.map((slide, index) => (
            ...
            >
              ...
              <div className="absolute inset-0">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-r from-lime-900/90 via-lime-800/50 to-lime-300/20"></div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="container mx-15  sm:px-6 h-full relative z-10 flex items-center">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:space-x-4">
              <Link href="/products" className="bg-white text-lime-900 px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg font-semibold hover:bg-lime-50 transition shadow-lg text-center">
                Explore Products
              </Link>
              <Link href="/credit-application" className="border-2 border-white text-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg font-semibold hover:bg-white hover:text-lime-900 transition backdrop-blur-sm text-center">
                Apply for Credit
              </Link>
            </div>
          </div>
      ...
      <section className="bg-gray-50">
        <div className="container mx-auto px-0">
          <div className="text-center mb-8 sm:mb-12 pt-12 sm:pt-20 px-4">
            <span className="text-lime-600 font-semibold text-xs sm:text-sm uppercase tracking-wider">Premium Collection</span>
              ...
              <Link key={index} href={product.href} className="group relative overflow-hidden">
                <div className="relative aspect-square">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-3 sm:p-4 md:p-8">
                    ...
                    <div className="w-8 sm:w-10 md:w-12 h-0.5 bg-lime-400 group-hover:w-12 sm:group-hover:w-16 md:group-hover:w-20 transition-all duration-300"></div>
                  </div>
                </div>
              </Link>
            ))}
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div>
              <span className="text-lime-600 font-semibold text-xs sm:text-sm uppercase tracking-wider">Why Choose Us</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                {[
                  ...
                  <div key={index} className="flex items-start space-x-3">
                    <div className="w-6 h-6 sm:w-8 sm:h-8 bg-lime-100 rounded-full flex items-center justify-center shrink-0">
                      <svg className="w-3 h-3 sm:w-4 sm:h-4 text-lime-600" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="relative mt-8 lg:mt-0">
              <div className="bg-gradient-to-br from-lime-600 to-lime-800 rounded-2xl p-1 shadow-2xl">
                <div className="bg-white rounded-xl p-4 sm:p-6 md:p-8">
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    <div className="flex items-start space-x-3 sm:space-x-4">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 bg-lime-100 rounded-lg flex items-center justify-center shrink-0">
                        <svg className="w-4 h-4 sm:w-5 sm:h-5 text-lime-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="text-sm sm:text-base">
                        ...
                        <p className="text-gray-600">20 Mount Pleasant, Harare</p>
                      </div>
                    </div>
                  ...
                  <div className="mt-4 sm:mt-6 rounded-lg overflow-hidden h-32 sm:h-40 md:h-48">
                    <iframe
                      src="https://www.google.com/maps/place/Avondale,+Harare/@-17.7939363,31.0255916,3594m/data=!3m2!1e3!4b1!4m6!3m5!1s0x1931a5779bbc282b:0x1adf2004b440bf6c!8m2!3d-17.7959448!4d31.0332235!16s%2Fm%2F02pjlg1?entry=ttu&g_ep=EgoyMDI2MDgzMS4wIKXMDSoASAFQAw%3D%3D"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      loading="lazy"
              ...
              <div className="hidden sm:block absolute -bottom-4 -right-4 w-24 md:w-32 h-24 md:h-32 bg-lime-100 rounded-full -z-10"></div>
              <div className="hidden sm:block absolute -top-4 -left-4 w-16 md:w-24 h-16 md:h-24 bg-lime-200 rounded-full -z-10"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative bg-gradient-to-r from-lime-900 to-lime-800 py-12 sm:py-16 md:py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 text-center relative">
          ...
          <p className="text-base sm:text-lg md:text-xl text-lime-100 mb-6 sm:mb-8 max-w-2xl mx-auto px-4">
            Take advantage of our flexible credit options. Get approved today and spread your payments.
          </p>
          <Link
            href="/credit-application"
            className="inline-flex items-center bg-white text-lime-900 px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:bg-lime-50 transition shadow-2xl text-sm sm:text-base md:text-lg"
          >
