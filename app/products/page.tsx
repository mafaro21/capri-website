...
export default function ProductsPage() {
    const categories = [
        ...
        },
        {
            ...
            items: '32 models',
            gradient: 'from-lime-700 to-lime-800'
        },
        {
            name: 'Solar',
            href: '/products/solar',
        ...
        },
        {
            ...
            items: '16 models',
            gradient: 'from-indigo-600 to-lime-700'
        },
        {
            name: 'Ice Makers',
            ...
            <section className="py-20 bg-gray-50">
                <div className="container mx-auto px-6">
                    ...
                    <div className="flex flex-wrap justify-between items-center mb-12">
                        <p className="text-gray-600 text-lg">Showing <span className="font-semibold text-lime-700">{categories.length}</span> product categories</p>
                        <div className="flex items-center space-x-3">
                            <span className="text-gray-700">Sort by:</span>
                            <select className="bg-white border border-gray-300 rounded-lg px-4 py-2 text-gray-700 focus:ring-2 focus:ring-lime-600 focus:border-transparent">
                                ...
                                <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 h-full flex flex-col">
                                    ...
                                    <div className="p-6 flex-1 flex flex-col">
                                        <div className="flex items-start justify-between mb-2">
                                            <h3 className="text-xl font-bold text-gray-900 group-hover:text-lime-600 transition">
                                                {category.name}
                                            </h3>
                                        </div>
                                        ...
                                        <div className="flex items-center justify-between mt-auto">
                                            ...
                                            <span className="inline-flex items-center text-lime-600 font-semibold group-hover:translate-x-2 transition">
                                                Browse
