...
export default function Contact() {
    return (
        <div className="min-h-screen bg-white">
            ...
            {/* Hero */}
            <section className="bg-gradient-to-r from-lime-700 via-lime-800 to-lime-900 text-white py-20">
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            ...
                            <div className="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition p-8">
                                ...
                                <p className="text-gray-600 text-center">20 Mount Pleasant, Harare</p>
                                <div className="mt-6 pt-6 border-t border-gray-100">
                                    <div className="flex items-center justify-center space-x-2 text-lime-700">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-lg font-semibold text-gray-900">08677 000004</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-lg font-semibold text-gray-900">+263 242 7579856</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-lg font-semibold text-gray-900">+263 710045700</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-lg font-semibold text-gray-900">info@appliances.co.zw</p>
                                            <p className="text-lg font-semibold text-gray-900">sales@appliances.co.zw</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="mt-16">
                            ...
                            <div className="h-[400px] rounded-xl overflow-hidden shadow-lg border border-gray-200">
                                <iframe
                                    ...
                                    style={{ border: 0 }}
                                    loading="lazy"
                                    title="appliances Zimbabwe Location"
                        ...
                        <div className="mt-16 bg-green-50 rounded-xl p-8 text-center">
                            ...
                            <Link
                                ...
                                className="inline-block bg-lime-700 text-white px-8 py-3 rounded-lg font-semibold hover:bg-green-700 transition shadow-lg"
                            >
                                Apply for Credit
                            </Link>
                        </div>
